...
{ 
    public static class Img2Sprite
    {
        ...
        public static Sprite LoadNewSprite(string filePath, SpriteMeshType spriteType = SpriteMeshType.Tight)
        {
            ...
            var newSprite = Sprite.Create(spriteTexture, new Rect(0, 0, spriteTexture.width, spriteTexture.height), new Vector2(spriteTexture.width/2.0f/max, 0), max, 0 , spriteType);
